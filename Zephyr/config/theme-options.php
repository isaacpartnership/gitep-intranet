...
unset( $config['styling']['fields']['h_colors_4'] );
...
unset( $config['blogoptions']['fields']['read_more_btn_style'] );
unset( $config['blogoptions']['fields']['read_more_btn_color'] );
unset( $config['blogoptions']['fields']['read_more_btn_size'] );
